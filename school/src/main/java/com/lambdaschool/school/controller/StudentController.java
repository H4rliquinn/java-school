...
public class StudentController
{
    ...
    @GetMapping(value = "/student/{StudentId}",
        ...
        long StudentId)
        {
            logger.info("GET "+request.getRequestURI()+" StudentId:"+StudentId+" accessed");
    ...
    {
        logger.info("GET "+request.getRequestURI()+" name:"+name+" accessed");
    ...
    {
        logger.info("POST "+request.getRequestURI()+" Student:"+newStudent.getStudname()+" added");
    ...
    public ResponseEntity<?> updateStudent(HttpServletRequest request,
            ...
            @PathVariable
                    long Studentid)
    {
        logger.info("PUT "+request.getRequestURI()+" Studentid:"+Studentid+" Student Name:"+updateStudent.getStudname()+" updated");
    ...
    public ResponseEntity<?> deleteStudentById(HttpServletRequest request,
            @PathVariable
                    long Studentid)
    {
        logger.info("DELETE "+request.getRequestURI()+" Studentid:"+Studentid+" Deleted");
